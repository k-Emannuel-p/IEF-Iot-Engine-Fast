...
export let scene2D = [];
export let scene3D = [];
export let sceneNode = '3d'; // Dimensions Selector
 ...
 */
export function print(x, y, char = " ", text_color = 'white', bg_color = 'white') {
 ...
 */
export function line(x1, y1, x2, y2, char = " ", text_color = 'white', bg_color = 'white') {
 ...
 */
export function rectangle2D(id) {
    const object = scene2D.find(obj => obj.id === id);
    if (!object) {
 ...
 */
export function find(scene_node, id) {
...
export function set(node, type, id){
    let object;
    switch(node){
        case '2d': 
            set2D(type, id);
 ...
 */
export function show(text, duration = 300) {
    messages.push({
        text: text,
        duration: duration
    });
 ...
 */
export function color(string, textColor = 'white', bgColor = 'black') {
 ...
 */
export function scale(object, value1 = 1, value2 = 1) {
    if (!object) {
 ...
 */
export function translate2D(object, x, y) {
    if (!object) { 
 ...
 */
export function rotate2D(object, angle) {
    if (!object) {
 ...
 */
export function newCamera(node, id){
    if(node === '3d'){
        cameras3D[id] = {
            id: id,
            position: [0, 0, 0], 
 ...
 */
export function setCamera(node, camera){
    if(node === '2d'){
        camera2D = camera;
    } else if(node === '3d'){
        camera3D = camera;
 ...
 */
export function rotate3D(object, angleX = 0, angleY = 0, angleZ = 0) {
    if (!object) {
        console.log(color(`-------- \n\n Attempted to rotate a null or undefined object. \n\n --------`, 'white', 'red'));
        return;
    }
 ...
 */
export function translate3D(object, x, y, z) {
    if (!object) { 
        console.log(color(`-------- \n\n Attempted to translate a null or undefined object. \n\n --------`, 'white', 'red'));
        return;
    }
